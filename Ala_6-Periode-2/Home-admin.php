...
<body>
    ...
    if (isset($_POST['deleteRecipe'])) {
        ...
        $stmt = $conn->prepare("DELETE FROM recepteboeken WHERE Boek_id = ?");
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($recipes as $recipe) : ?>
                <tr>
                    <td><?php echo $recipe['Boek_id']; ?></td>
                    <td><?php echo $recipe['Boek_naam']; ?></td>
                    <!-- Add other necessary columns here -->
                    <td>
                        <form method="post" onsubmit="return confirm('Are you sure you want to delete this recipe?');">
                            <input type="hidden" name="recipeId" value="<?php echo $recipe['Boek_id']; ?>">
                            <button type="submit" name="deleteRecipe">Verwijder</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
